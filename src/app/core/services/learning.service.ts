...
export class LearningService {
  ...
  createAssessmentQuestion(assessmentId:string,request:{questionText:string;questionType:string;points:number;options:{text:string;correct:boolean}[]}):Observable<ApiResponse<{id:string}>>{return this.http.post<ApiResponse<{id:string}>>(`${this.base}/assessments/${encodeURIComponent(assessmentId)}/questions`,request);}
