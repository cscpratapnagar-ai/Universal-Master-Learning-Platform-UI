...
export interface Lesson{id:string;title:string;contentType:string;content:string;sortOrder:number;completionMode?:'AUTO_COMPLETE'|'MANUAL_COMPLETE'|'ASSESSMENT_REQUIRED'|string;completed:boolean;locked?:boolean;unmetPrerequisiteLessonIds?:string[];}
