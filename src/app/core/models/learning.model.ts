...
export interface Lesson{id:string;title:string;contentType:string;content:string;sortOrder:number;completed:boolean;locked?:boolean;unmetPrerequisiteLessonIds?:string[];}
